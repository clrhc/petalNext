    ...
    async function init() {
      try {
        const data = await readContracts(config, {
          contracts: [
            { address: Data.petalFactory as Address, abi: factory.abi as Abi, functionName: 'tokenLaunched', args: [Data.petalToken as Address] },
            { address: Data.petalFactory as Address, abi: factory.abi as Abi, functionName: 'bondingCurves', args: [Data.petalToken as Address] },
            { address: Data.uniswapRouter as Address, abi: uniswapRouter.abi as Abi, functionName: 'getAmountsOut', args: [parseUnits('1', 18), [Data.petalToken as Address, Data.WETH as Address]] },
          ],
          allowFailure: true,
        });
